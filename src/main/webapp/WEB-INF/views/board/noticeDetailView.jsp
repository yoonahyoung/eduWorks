	    ...
	    <div class="su_contentArea">
	        ...
	        <div class="su_board_body">
	            ...
	            <div class="su_board_count tableOption">
	                ...
	                <div>
	                    <a href="#" onclick="window.open('noticeMailForm.no?no=${b.boardNo}','window_name','width=1116,height=885,location=writeMailForm.ma,status=no,scrollbars=yes');" style="color:black; margin-top:0px">
