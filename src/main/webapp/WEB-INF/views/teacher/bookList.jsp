                ...
                <nav aria-label="Page navigation example">
                    ...
                    <c:choose>
						    ...
						    <c:when test="${ not empty condition }">
						    	<li class="page-item">
						            <a class="page-link" style="color:slategray" href="bookSearchForm.bk?cpage=${ pi.currentPage-1 }&condition=${condition}&keyword=${keyword}" aria-label="Previous">
						            <span aria-hidden="true">&laquo;</span>
						            </a>
						        </li>
						    </c:when>
					    ...
					    <c:choose>
			        		<c:when test="${ pi.currentPage eq pi.maxPage }">
						     ...
						     <c:when test="${ not empty condition }">
						    	<li class="page-item">
						            <a class="page-link" style="color:slategray" href="bookSearchForm.bk?cpage=${ pi.currentPage+1 }&condition=${condition}&keyword=${keyword}" aria-label="Next">
						            <span aria-hidden="true">&raquo;</span>
						            </a>
						        </li>
						    </c:when>
